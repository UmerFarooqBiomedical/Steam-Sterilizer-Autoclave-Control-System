...
bool seventhpulse = false;
bool eighthpulse = false;
bool ninthpulse = false;
bool tenthpulse = false;
bool eleventhpulse = false;
bool twelvethpulse = false;
bool thirteenthpulse = false;
bool fourteenthpulse = false;
bool first = false;
  ...
  for (;;)
  {
    ...
    if (secondpulse == true && dcsx == HIGH && thirdpulse == false && fourthpulse == false && fifthpulse == false && sixthpulse == false)
    {
      for (; tsx <= 134;)
      {
        ...
        n1.setValue(tsx);
        t5.setText("First Pulse");
        dbSerialPrintln("First Pulse");
    ...
    //// Steam enters till temperature reach
    if (dcsx == HIGH && tsx >= 134 && secondpulse == true && thirdpulse == true && fourthpulse == false && fifthpulse == false && sixthpulse == false)
    {
      digitalWrite(dlock, LOW);
    ...
    n1.setValue(tsx);
    if (secondpulse == true && dcsx == HIGH && thirdpulse == true && fourthpulse == true && fifthpulse == true && sixthpulse == true && seventhpulse == false)
    {
      for (; tsx <= 134;)
      {
        tsx = ktc.readCelsius();
        ...
        n1.setValue(tsx);
        t5.setText("Second Pulse");
        dbSerialPrintln("Second Pulse");
    ...
    //// Steam enters till temperature reach
    if (dcsx == HIGH && tsx >= 134 && thirdpulse == true && fourthpulse == true && fifthpulse == true && sixthpulse == true && seventhpulse == true && eighthpulse == false)
    {
      digitalWrite(dlock, LOW);
      digitalWrite(stcv, HIGH);
      tsx = ktc.readCelsius();
    ...
    //// Exhaust Second pulse
    if (secondpulse == true && dcsx == HIGH && digitalRead(pswitch) == HIGH && thirdpulse == true && fourthpulse == true && fifthpulse == true && sixthpulse == true && seventhpulse == true && eighthpulse == true && ninthpulse == false)
    {
      for (; digitalRead(pswitch) == HIGH;)
      {
        t5.setText("Exhaust");
    ...
    ////Last Pulse Starts
    ////Vaccum Phase
    if (secondpulse == true && dcsx == HIGH && thirdpulse == true && fourthpulse == true && fifthpulse == true && sixthpulse == true && seventhpulse == true && eighthpulse == true && ninthpulse == true && tenthpulse == false)
    {

      n1.setValue(tsx);
      ////Last Pulse Process
      float endtime3 = millis() + 180000;
      for (; millis() <= endtime3;)
    ...
    if (secondpulse == true && dcsx == HIGH && thirdpulse == false && fourthpulse == false && fifthpulse == false && sixthpulse == true && seventhpulse == true && eighthpulse == true && ninthpulse == true && tenthpulse == true && eleventhpulse == false)
    {
      for (; tsx <= 134;)
      {
        tsx = ktc.readCelsius();
    ...
    if (dcsx == HIGH && tsx >= 134 && thirdpulse == true && fourthpulse == true && fifthpulse == true && sixthpulse == true && seventhpulse == true && eighthpulse == true && ninthpulse == true && tenthpulse == true && eleventhpulse == true && twelvethpulse == false)
    {
      float endtime4 = millis() + 300000;
      for (; millis() <= endtime4;)
      {
        ...
        delay(200);
        n1.setValue(tsx);
        if (dcsx == HIGH && tsx <= 132 && thirdpulse == true && fourthpulse == true && fifthpulse == true && sixthpulse == true && seventhpulse == true && eighthpulse == true && ninthpulse == true && tenthpulse == true && eleventhpulse == true && twelvethpulse == false)
        {
          digitalWrite(dlock, LOW);
          digitalWrite(stcv, LOW);
        }
        else if (dcsx == HIGH && tsx >= 136 && thirdpulse == true && fourthpulse == true && fifthpulse == true && sixthpulse == true && seventhpulse == true && eighthpulse == true && ninthpulse == true && tenthpulse == true && eleventhpulse == true && twelvethpulse == false)
        {
          digitalWrite(stcv, HIGH);
          digitalWrite(dlock, LOW);
        }
    ...
    if (secondpulse == true && dcsx == HIGH && digitalRead(pswitch) == HIGH && thirdpulse == true && fourthpulse == true && fifthpulse == true && sixthpulse == true && seventhpulse == true && eighthpulse == true && ninthpulse == true && tenthpulse == true && eleventhpulse == true && twelvethpulse == true && thirteenthpulse == false)
    {
      for (; digitalRead(pswitch) == HIGH;)
      {
        tsx = ktc.readCelsius();
    ...
    if (secondpulse == true && dcsx == HIGH && digitalRead(pswitch) == LOW && thirdpulse == true && fourthpulse == true && fifthpulse == true && sixthpulse == true && seventhpulse == true && eighthpulse == true && ninthpulse == true && tenthpulse == true && eleventhpulse == true && twelvethpulse == true && thirteenthpulse == false)
    {
      tsx = ktc.readCelsius();
      delay(200);
      n1.setValue(tsx);
      digitalWrite(ev, HIGH);
      thirteenthpulse = true;
    }

    if (secondpulse == true && dcsx == HIGH && thirdpulse == true && fourthpulse == true && fifthpulse == true && sixthpulse == true && seventhpulse == true && eighthpulse == true && ninthpulse == true && tenthpulse == true && eleventhpulse == true && twelvethpulse == true && thirteenthpulse == true && fourteenthpulse == false)
    {
      float endtime5 = millis() + 360000;
      for (; millis() <= endtime5;)
      {
        tsx = ktc.readCelsius();
        delay(200);
